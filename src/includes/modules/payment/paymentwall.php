...
class paymentwall
{
  ...
  function update_status()
  {
    ...
    if ( ($this->enabled == true) && ((int)MODULE_PAYMENT_PAYMENTWALL_ZONE > 0) ) {
      $check_flag = false;
  ...
  function install()
  {
    ...
    " (configuration_title, configuration_key, configuration_value, configuration_description, 
      ...
      values ('Enable Paymentwall Module', 'MODULE_PAYMENT_PAYMENTWALL_STATUS', 'True', 
        'Do you want to accept Paymentwall payments?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
    ...
    " (configuration_title, configuration_key, configuration_value, configuration_description, 
      ...
      values ('Application key.', 'MODULE_PAYMENT_PAYMENTWALL_APP_KEY', '', 
